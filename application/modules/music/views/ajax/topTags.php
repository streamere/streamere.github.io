...
<div class="page-header">
  ...
  <button class="btn btn-warning pull-right" onclick="start_radio('<?php echo addslashes($top->toptracks->track[$itemRand]->name); ?>','<?php echo addslashes($top->toptracks->track[$itemRand]->artist->name); ?>','<?php echo $image; ?>')"><i class="fa fa-rss"></i> <?php echo ___("label_start_radio"); ?></button></h1>
 </div>
 <div class="row">
<?php
