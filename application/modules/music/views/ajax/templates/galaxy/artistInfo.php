...
foreach ($toptracks->toptracks->track as $key => $value) {
	...
	{
	?>		
	  <a href="<?php echo base_url(); ?>?arist=<?php echo $value->artist->name; ?>&track=<?php echo $value->name; ?>')" onClick="return false;" class="list-group-item removehref">	  		
	  		...
	  		<div class="btn-group pull-right">
                ...
                {
                    ?><button  onClick="buyOnAmazon('<?php echo addslashes($value->name); ?> - <?php echo addslashes($value->artist->name); ?>')" class="btn btn-default btn-xs" title="<?php echo ___("label_buy_on_amazon"); ?>"><i class="fa fa-shopping-cart"></i></button><?php
                }
                ?>
            </div>
	  </a>
