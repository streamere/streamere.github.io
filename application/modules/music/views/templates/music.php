  ...
  <div id="fb-root"></div>
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper" class="panel panel-primary">
            ...
            {
              ?><button id="amazon" data-amazon="<?php echo $this->config->item("amazon_afiliate"); ?>" class="btn btn-warning btn-sm amazon" style="position:absolute;margin-top:210px;width:100%;border-radius:0px"><i class="fa fa-shopping-cart"></i> <?php echo ___("label_buy_on_amazon"); ?></button><?php
            }
            ?>
            	<div id="player">  
